...
@section('page_content')
    <div class="container">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
            <form action="{{ route('organizer.updateUser', $user->id) }}" method="POST">
                @csrf
                @method('put')
                <div class="col">
                            ...
                            <div class="col-xl-12">
                                <div class="card-body p-md-4 text-black">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <a href="{{ route('organizer.showUserProfile',$user->id) }}">
                                                <button type="button" class="btn btn-warning">Alumni-Profile</button>
                                            </a>
                                        </div>
                                        <h3 class="mb-4 text-center text-uppercase flex-grow-1">Update-Alumni</h3>
                                        <div>
                                            <a href="{{ route('organizer.showUserProfile',$user->id) }}">
