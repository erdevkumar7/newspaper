                    ...
                    <div class="card card-registration my-2">         
                        ...
                        <div class="row g-0">
                            <div class="col-xl-6 d-none d-xl-block">
                                <img src="{{ asset('/public/images/allumni_img/welcome_vol.png') }}" alt="Sample photo"
                                    class="img-fluid"
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-4 text-black my-4">
                                    <h3 class="mb-4 text-uppercase">Volunteer Login </h3>
