        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li class="new-manage"><a><i class="fa fa-globe"></i> Volunteer-Management <span
                                class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ route('admin.allOrganizer') }}">All volunteer</a></li>
                            <li><a href="{{ route('admin.addOrganizer') }}">Add volunteer</a></li>
                        </ul>
                    </li>
